...
def visualbackprop_runner(models: Dict[str, str], datasets: Dict[str, str], output_prefix: str = "."):
    """
...
if __name__ == "__main__":
    ...
    datasets = {
        "fall": "/media/dolphonie/Data/Files/UROP/devens_data/8-4-21 fall/1628106140.64",
        "winter": "/media/dolphonie/Data/Files/UROP/devens_data/10-29-21 winter/1635515333.207994",
        "online_ncp": "/media/dolphonie/Data/Files/UROP/devens_data/11-18-21 online/raw_data/1637252567.166090",
        "online_cfc": "/media/dolphonie/Data/Files/UROP/devens_data/11-18-21 online/raw_data/1637254105.961565",
        "online_lstm": "/media/dolphonie/Data/Files/UROP/devens_data/11-18-21 online/raw_data/1637251162.043868",
    }
