...
kubectl apply -f deepdrone-target-redwood-odernn-job.yaml
kubectl apply -f deepdrone-target-redwood-ncp-job.yaml
kubectl apply -f deepdrone-target-redwood-lstm-job.yaml
kubectl apply -f deepdrone-target-redwood-ctgru-job.yaml
...
kubectl apply -f deepdrone-target-neighborhood-odernn-job.yaml
...
kubectl apply -f deepdrone-target-neighborhood-ctgru-job.yaml

kubectl apply -f deepdrone-maze-redwood-rnn-job.yaml
kubectl apply -f deepdrone-maze-redwood-odernn-job.yaml
...
kubectl apply -f deepdrone-maze-neighborhood-odernn-job.yaml
...
kubectl apply -f deepdrone-hiking-redwood-ctgru-job.yaml
kubectl apply -f deepdrone-hiking-redwood-lstm-job.yaml
kubectl apply -f deepdrone-hiking-redwood-odernn-job.yaml
...
kubectl apply -f deepdrone-hiking-neighborhood-odernn-job.yaml
kubectl apply -f deepdrone-hiking-neighborhood-ctgru-job.yaml
...
kubectl apply -f deepdrone-following-redwood-odernn-job.yaml
...
kubectl apply -f deepdrone-following-redwood-ctgru-job.yaml
kubectl apply -f deepdrone-following-redwood-cnn-job.yaml

kubectl apply -f deepdrone-following-neighborhood-rnn-job.yaml
kubectl apply -f deepdrone-following-neighborhood-odernn-job.yaml
...
kubectl apply -f deepdrone-following-neighborhood-ctgru-job.yaml
